...
| `implementation-contract-invalid` | Bad/missing `--contract-file` (schema, symlink path, empty writeScopes, target mismatch) before Grok. | Fix the contract JSON; reject symlink contract paths. |
